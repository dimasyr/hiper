        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <form action="{{ route('alatberat.update', ['id' => $alatberat->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        <input type="hidden" name="_method" value="PATCH">
                        <div class="row form-group">
                            <div class="col col-md-2"><label for="nama" class=" form-control-label">Nama</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="nama" name="nama" value="{{ $alatberat->nama }}"
                                    class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="tahun" name="tahun" value="{{ $alatberat->tahun }}"
                                    class="form-control">
                                <small class="form-text text-muted alert-danger">
                                    @if($errors->has('tahun'))
                                        {{ $errors->first('tahun') }}
