                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-6"><label class=" form-control-label">{{ $onderdilKendaraan->getOnderdil(false)->nama }}</label></div>
                                        <div class="col-12 col-md-6">
                                            <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample{{ $loop->iteration }}" aria-expanded="false" aria-controls="collapseExample{{$loop->iteration}}">Detail
                                            </button>
                                        </div>
                                    </div>
                                    @endforeach
