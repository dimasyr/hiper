...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="#">
                        <a href="#"><i class="menu-icon ti-close"></i>Logout </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden" href="{{ route('dashboard')}}"><img src="{{asset('images/logo.png')}}" alt="Logo"></a>
            ...
            <div class="top-right">
                <div class="header-menu">
                    ...
                    <div class="float-right">
                        <h4 style="padding-top: 13px; color: grey">Selamat datang, Admin</h4>
                    </div>
                </div>
            </div>
        </header>
    ...
    <script src="{{asset('js/js/init/weather-init.js')}}"></script>
