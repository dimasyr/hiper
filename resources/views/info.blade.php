                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile"
                                                role="tab" aria-controls="pills-profile" aria-selected="false">Onderdil</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                            ...
                                            <div class="col-md-8">
                                                <div class="card">
                                                    <img class="card-img-top" src="{{ asset('images/truk_gandeng.jpg') }}"
                                                        alt="Card image cap">
                                                    <div class="card-body">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="progress mb-2">
                                                                            <div class="text-dark font-weight-bold progress-bar bg-info progress-bar-striped progress-bar-animated"
                                                                                role="progressbar" style="width: {{ number_format($kendaraan->getStatusOnderdil($onderdil->id)['status'],2) }}%"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <button type="button" class="btn btn-secondary btn-sm"
                                                                                data-toggle="modal" data-target="#mediumModal{{ $loop->iteration }}">
                                                                                Detail
                                                                            </button>
                                                                        </div>

                                                                        {{--modal detail button--}}
                                                                        <div class="table-responsive-md modal fade" id="mediumModal{{ $loop->iteration }}"
                                                        ...
                                                        <table id="" class="table table-striped table-bordered">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{
                                                                        formatDate(\Carbon\Carbon::parse($permintaan->created_at),false,false)
                                                                        }}</td>
                                                                    <td>
